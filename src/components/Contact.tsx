          ...
          <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span>techbishal566@gmail.com</span>
              </a>
              <a
                href="https://github.com/Techno-Bishal"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
              >
                <Github className="w-6 h-6" />
                <span>github.com/Techno-Bishal</span>
              </a>
              <a
                href="https://www.linkedin.com/in/bishal-kc01"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
              >
                <Linkedin className="w-6 h-6" />
                <span>linkedin.com/in/Bishal-kc-01</span>
              </a>
            </div>
          </div>
